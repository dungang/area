...
class ActiveForm extends Widget
{
     ...
     * @see fieldConfig
     */
    public $fieldClass = 'dungang\area\widgets\ActiveField';
    /**
     ...
     * @param string|array $attribute the attribute name or expression. See [[Html::getAttributeName()]] for the format
